...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _direction__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./direction */ \"./src/direction.js\");\n/* harmony import */ var _structures_linked_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./structures/linked-list */ \"./src/structures/linked-list.js\");\n/* harmony import */ var _structures_vector_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./structures/vector.js */ \"./src/structures/vector.js\");\n\r\n\r\n\r\n\r\nclass Snake {\r\n    #body;\r\n    #direction;\r\n    constructor(initialPosition, initialDirection = _direction__WEBPACK_IMPORTED_MODULE_0__.default.UP) {\r\n        this.#direction = initialDirection;\r\n        const oppositeDirection = (0,_direction__WEBPACK_IMPORTED_MODULE_0__.getDirectionOpposite)(initialDirection);\r\n        this.#body = new _structures_linked_list__WEBPACK_IMPORTED_MODULE_1__.default();\r\n        const directionVector = (0,_direction__WEBPACK_IMPORTED_MODULE_0__.directionAsVector)(oppositeDirection);\r\n        this.#body.push(new SnakeSegment(initialPosition));\r\n        this.#body.push(new SnakeSegment(_structures_vector_js__WEBPACK_IMPORTED_MODULE_2__.default.add(initialPosition, directionVector)));\r\n        this.#body.push(new SnakeSegment(_structures_vector_js__WEBPACK_IMPORTED_MODULE_2__.default.add(initialPosition, directionVector.multiplyScalar(2))));\r\n\r\n    }\r\n\r\n    changeDirection(newDirection) {\r\n        const oppositeDirection = (0,_direction__WEBPACK_IMPORTED_MODULE_0__.getDirectionOpposite)(this.#direction);\r\n\r\n        if ((0,_direction__WEBPACK_IMPORTED_MODULE_0__.isDirection)(newDirection) && newDirection !== oppositeDirection) {\r\n            this.#direction = newDirection;\r\n        }\r\n    }\r\n\r\n    move() {\r\n        let node = this.#body.head;\r\n        const directionVector = (0,_direction__WEBPACK_IMPORTED_MODULE_0__.directionAsVector)(this.#direction);\r\n        let currentPosition = node.value().position;\r\n        let newPosition = _structures_vector_js__WEBPACK_IMPORTED_MODULE_2__.default.add(currentPosition, directionVector);\r\n        let i = 1;\r\n\r\n        while (i <= this.#body.length) {\r\n            currentPosition = node.value().position;\r\n\r\n            node.setValue({\r\n                position: newPosition\r\n            });\r\n\r\n            newPosition = currentPosition;\r\n            node = node.next();\r\n\r\n            i++;\r\n        }\r\n    }\r\n\r\n    eat() {\r\n        const last = this.#body.tail.value();\r\n        this.#body.push(last);\r\n    }\r\n\r\n    getBody() {\r\n        return this.#body;\r\n    }\r\n\r\n    getDirection() {\r\n        return this.#direction;\r\n    }\r\n\r\n    getPositions() {\r\n        const positions = [];\r\n\r\n        let node = this.#body.head;\r\n        let i = 0;\r\n\r\n        while (i < this.#body.length) {\r\n            positions.push(node.value().position.get());\r\n            node = node.next();\r\n            i++;\r\n        }\r\n\r\n        return positions;\r\n    }\r\n\r\n    getBodyPositions() {\r\n        const positions = this.getPositions();\r\n        positions.shift();\r\n        return positions;\r\n    }\r\n\r\n    getHeadPosition() {\r\n        return this.#body.head.value().position;\r\n    }\r\n\r\n    setHeadPosition(newPosition) {\r\n        this.#body.head.setValue(new SnakeSegment(newPosition));\r\n    }\r\n\r\n    hasOverlapped() {\r\n        const positions = this.getPositions();\r\n        positions.shift();\r\n        return positions.filter((position) => _structures_vector_js__WEBPACK_IMPORTED_MODULE_2__.default.isEqual(position, this.#body.head.value().position)).length > 0;\r\n    }\r\n}\r\n\r\nclass SnakeSegment {\r\n    constructor(position) {\r\n        this.position = position;\r\n    }\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Snake);\n\n//# sourceURL=webpack://snake/./src/snake.js?");
